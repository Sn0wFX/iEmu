...
extern void switch_iop_mode(struct CPUARMState *env, uint32_t new_mode);
extern struct CPUARMState *get_current_cpu(void);

typedef struct s5l8930_iop_s
{
	struct CPUARMState *s5l8930env;
	struct CPUARMState *iopenv;
	qemu_irq **irq;
...
/* static struct CPUARMState *IOP struct CPUARMState;
static struct CPUARMState *Main struct CPUARMState; */
static void *IOPState;

struct CPUARMState *getMainCpuEnv(void) {
	/* return Main struct CPUARMState; */
}
struct CPUARMState *getIOPCpuEnv(void) {
	/* return IOP struct CPUARMState; */
}
...
/*	IOP struct CPUARMState = s->iopenv;
	Main struct CPUARMState = s5l8930->env; */ /* doesnt work for some reason ;-; */
	IOPState = s;
