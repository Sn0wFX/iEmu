...
void arm_translate_init(void)
{
    ...
    for (i = 0; i < 16; i++) {
        cpu_R[i] = tcg_global_mem_new_i32(TCG_AREG0,
                                          offsetof(struct CPUARMState, regs[i]),
                                          regnames[i]);
    }
    cpu_exclusive_addr = tcg_global_mem_new_i32(TCG_AREG0,
        offsetof(struct CPUARMState, exclusive_addr), "exclusive_addr");
    cpu_exclusive_val = tcg_global_mem_new_i32(TCG_AREG0,
        offsetof(struct CPUARMState, exclusive_val), "exclusive_val");
    cpu_exclusive_high = tcg_global_mem_new_i32(TCG_AREG0,
        offsetof(struct CPUARMState, exclusive_high), "exclusive_high");
#ifdef CONFIG_USER_ONLY
    cpu_exclusive_test = tcg_global_mem_new_i32(TCG_AREG0,
        offsetof(struct CPUARMState, exclusive_test), "exclusive_test");
    cpu_exclusive_info = tcg_global_mem_new_i32(TCG_AREG0,
        offsetof(struct CPUARMState, exclusive_info), "exclusive_info");
#endif
...
#define load_cpu_field(name) load_cpu_offset(offsetof(struct CPUARMState, name))
...
#define store_cpu_field(var, name) \
    store_cpu_offset(var, offsetof(struct CPUARMState, name))
...
#define gen_set_CF(var) tcg_gen_st_i32(var, cpu_env, offsetof(struct CPUARMState, CF))
...
{
    tcg_gen_st_i32(var, cpu_env, offsetof(struct CPUARMState, NF));
    tcg_gen_st_i32(var, cpu_env, offsetof(struct CPUARMState, ZF));
}
...
#define gen_pas_helper(name) glue(gen_helper_,name)(a, a, b, tmp)
    case 1:
        ...
        tcg_gen_addi_ptr(tmp, cpu_env, offsetof(struct CPUARMState, GE));
        PAS_OP(s)
...
static inline void gen_bx_im(DisasContext *s, uint32_t addr)
{
    ...
    if (s->thumb != (addr & 1)) {
        ...
        tcg_gen_st_i32(tmp, cpu_env, offsetof(struct CPUARMState, thumb));
        tcg_temp_free_i32(tmp);
    }
...
static inline void store_reg_bx(struct CPUARMState *env, DisasContext *s,
                                int reg, TCGv var)
{
...
{
    tcg_gen_ld_i64(var, cpu_env, offsetof(struct CPUARMState, iwmmxt.regs[reg]));
}

static inline void iwmmxt_store_reg(TCGv_i64 var, int reg)
{
    tcg_gen_st_i64(var, cpu_env, offsetof(struct CPUARMState, iwmmxt.regs[reg]));
}

static inline TCGv iwmmxt_load_creg(int reg)
{
    TCGv var = tcg_temp_new_i32();
    tcg_gen_ld_i32(var, cpu_env, offsetof(struct CPUARMState, iwmmxt.cregs[reg]));
    return var;
}

static inline void iwmmxt_store_creg(int reg, TCGv var)
{
    tcg_gen_st_i32(var, cpu_env, offsetof(struct CPUARMState, iwmmxt.cregs[reg]));
    tcg_temp_free_i32(var);
}
...
static int disas_iwmmxt_insn(struct CPUARMState *env, DisasContext *s, uint32_t insn)
{
    int rd, wrd;
...
/* Disassemble an XScale DSP instruction.  Returns nonzero if an error occured
   (ie. an undefined instruction).  */
static int disas_dsp_insn(struct CPUARMState *env, DisasContext *s, uint32_t insn)
{
...
static int disas_cp_insn(struct CPUARMState *env, DisasContext *s, uint32_t insn)
{
    TCGv tmp, tmp2;
...
static int cp15_tls_load_store(struct CPUARMState *env, DisasContext *s, uint32_t insn, uint32_t rd)
{
    TCGv tmp;
    int cpn = (insn >> 16) & 0xf;
    int cpm = insn & 0xf;
...
/* Disassemble system coprocessor (cp15) instruction.  Return nonzero if
   instruction is not defined.  */
static int disas_cp15_insn(struct CPUARMState *env, DisasContext *s, uint32_t insn)
{
    uint32_t rd;
    TCGv tmp, tmp2;
...
/* Disassemble a VFP instruction.  Returns nonzero if an error occured
   (ie. an undefined instruction).  */
static int disas_vfp_insn(struct CPUARMState * env, DisasContext *s, uint32_t insn)
{
...
static uint32_t msr_mask(struct CPUARMState *env, DisasContext *s, int flags, int spsr) {
    uint32_t mask;
...
static int disas_neon_ls_insn(struct CPUARMState * env, DisasContext *s, uint32_t insn)
{
    int rd, rn, rm;
    int op;
    int nregs;
...
static int disas_neon_data_insn(struct CPUARMState * env, DisasContext *s, uint32_t insn)
{
    int op;
    int q;
    int rd, rn, rm;
...
static int disas_cp14_read(struct CPUARMState * env, DisasContext *s, uint32_t insn)
{
    int crn = (insn >> 16) & 0xf;
    int crm = insn & 0xf;
    int op1 = (insn >> 21) & 7;
...
static int disas_cp14_write(struct CPUARMState * env, DisasContext *s, uint32_t insn)
{
    int crn = (insn >> 16) & 0xf;
    int crm = insn & 0xf;
    int op1 = (insn >> 21) & 7;
...
static int disas_coproc_insn(struct CPUARMState * env, DisasContext *s, uint32_t insn)
{
    int cpnum;
...
static void disas_arm_insn(struct CPUARMState * env, DisasContext *s)
{
            ...
            if (insn & (1 << 4)) {
                ...
                case 1:
                    if ((insn & 0x00700020) == 0) {
                        ...
                        tmp2 = load_reg(s, rm);
                        tmp3 = tcg_temp_new_i32();
                        tcg_gen_ld_i32(tmp3, cpu_env, offsetof(struct CPUARMState, GE));
...
/* Translate a 32-bit thumb instruction.  Returns nonzero if the instruction
   is not legal.  */
static int disas_thumb2_insn(struct CPUARMState *env, DisasContext *s, uint16_t insn_hw1)
{
...
static void disas_thumb_insn(struct CPUARMState *env, DisasContext *s)
{
...
static inline void gen_intermediate_code_internal(struct CPUARMState *env,
                                                  TranslationBlock *tb,
                                                  int search_pc)
{
     ...
     * bits back to the struct CPUARMState for every instruction in an IT block. So:
     * (1) if the condexec bits are not already zero then we write
     * zero back into the struct CPUARMState now. This avoids complications trying
     * to do it at the end of the block. (For example if we don't do this
     * it's hard to identify whether we can safely skip writing condexec
     * at the end of the TB, which we definitely want to do for the case
     * where a TB doesn't do anything with the IT state at all.)
     * (2) if we are going to leave the TB then we call gen_set_condexec()
     * which will write the correct value into struct CPUARMState if zero is wrong.
     ...
     * then the struct CPUARMState will be wrong and we need to reset it.
     ...
     * we don't need to care about whether struct CPUARMState is correct in the
     * middle of a TB.
     */
...
void gen_intermediate_code(struct CPUARMState *env, TranslationBlock *tb)
{
    gen_intermediate_code_internal(env, tb, 0);
}

void gen_intermediate_code_pc(struct CPUARMState *env, TranslationBlock *tb)
{
...
void cpu_dump_state(struct CPUARMState *env, FILE *f, fprintf_function cpu_fprintf,
                    int flags)
{
    int i;
#if 0
...
void gen_pc_load(struct CPUARMState *env, TranslationBlock *tb,
